...
export default {
  ...
  keys: 'cool-admin-keys-laofansay',
  koa: {
  ...
  cors: {
    ...
    allowMethods: 'GET,HEAD,PUT,POST,DELETE,PATCH,OPTIONS', // 允许的HTTP方法
    allowHeaders: ['Content-Type', 'Authorization', 'X-Requested-With'], // 允许的HTTP头
  },
  // 静态文件配置
  staticFile: {
    buffer: true,
