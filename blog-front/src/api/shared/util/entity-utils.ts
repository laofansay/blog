...
export const overrideSortStateWithQueryParams = (paginationBaseState: ISortBaseState, locationSearch: URLSearchParams) => {
...
export const overridePaginationStateWithQueryParams = (paginationBaseState: IPaginationBaseState, searchParams: URLSearchParams) => {
  const sortedPaginationState: IPaginationBaseState = <IPaginationBaseState>(
    overrideSortStateWithQueryParams(paginationBaseState, searchParams)
  );
